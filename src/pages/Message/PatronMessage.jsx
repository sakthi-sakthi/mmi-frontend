...
const PatronMessage = () => {
    ...
    useEffect(() => {
        const fetchMessages = async () => {
            try {
                const response = await axios.get(`${ApiUrl}/get/messages/6`);
    ...
    return (
        <div className="container mt-3">
            <div className="section-title text-center">
                <h4 className="our-title mb-2">Patron Message</h4>
            </div>

            {latestMessage && (
                <MessageContainer>
                    <img src="images/all-img/MMI-Patron-Bishop.jpg" alt="REV. FRANCIS KALIST" style={{ width: '100px', height: '100px', borderRadius: '50%', boxShadow:"0px 4px 8px rgba(0, 0, 0, 0.1)" }} title='REV. FRANCIS KALIST' />
                    <MessageContent dangerouslySetInnerHTML={{ __html: latestMessage.content }} />
                     <div style={{ textAlign: 'right' }}>
                        <h5>REV. FRANCIS KALIST</h5>
                        <p><b>PATRON BISHOP</b></p>
                    </div>
                </MessageContainer>
            )}
                            ...
                            <div className="accordion-body">
                                {olderMessages.map(message => (
                                    <MessageContainer key={message.id}>
                                        ...
                                        <img src="images/all-img/MMI-Patron-Bishop.jpg" alt="REV. FRANCIS KALIST" style={{ width: '100px', height: '100px', borderRadius: '50%', marginBottom: '10px',boxShadow:"0px 4px 8px rgba(0, 0, 0, 0.1)" }} title='REV. FRANCIS KALIST' />
                                    </MessageContainer>
                                ))}
                            </div>
                        </div>
